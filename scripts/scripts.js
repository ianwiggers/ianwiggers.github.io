//  [There is true hope, true love, and true peace in Jesus alone.] Copyright (C) RVA Robotics Team | Innovation Department 2023. All rights reserved.
...
/*
let claimHeight = (pixelHeight * (1 - changeFactorH));
document.getElementById("claim").style.height = claimHeight.toString() + "px";
*/
// ...> <span id="changing-instruments">
/*
var alpha = 1.00;
var words = ["trumpet","saxophone","percussion","trombone","French horn","clarinet","flute","piano"];
...
// instrumentOutput.innerHTML !== (words[(currentWordIndex - 1)]).toString()
setInterval(changeInstrument, 1000);
*/
var alpha = 1.00;
var words = ["trumpet","saxophone","percussion"," trombone","French horn"," clarinet","flute","piano"];
var clarifyFunctionCallings = 0;
